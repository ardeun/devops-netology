...
PS C:\Users\anton.moiseev\WSL\docker\05-virt-03-docker\devops-netology\virt-homework\07-terraform-03-basic\src> terraform plan
data.yandex_compute_image.ubuntu: Reading...
data.yandex_compute_image.ubuntu: Read complete after 0s [id=fd8kdq6d0p8sij7h5qe3]
...
Terraform will perform the following actions:
  ...
  # yandex_compute_instance.test2["v1"] will be created
